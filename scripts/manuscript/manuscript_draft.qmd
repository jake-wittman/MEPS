...
The data we used comes from the full-year consolidated file from MEPS for the 12 year time span. Our analysis is adjusted for the complex survey design, including clustering and stratification. 
